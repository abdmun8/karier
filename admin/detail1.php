...
<body>
    ...
    <table border="1" align="center">
        <tr align="center" id="can_pathway">
            <td><span class="style1">NO</span></td>
            <td><span class="style1">
            Tanggal Konsul</span></td>
            <td><span class="style1">Riwayat Konsul</span></td>
        </tr>
        <?php
        ...
        if ($brs==0) { 
            echo"<tr align=\"center\"><td colspan=4>Siswa ini Belum Konsultasi</td></tr>"; }
        else {
            $no = 1;
