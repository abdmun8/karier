...
<body>
    ...
    <table width="350" cellpadding="0" cellspacing="1" class="keliling" align="center" bgcolor="#999999">
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td width="237" height="25">
                <input name="hak" type="radio" value="Pakar" checked />Pakar
            </td>
        </tr>
        <tr bgcolor="#FFFFFF">
    ...
    $Hak=$_POST['hak'];
            ...
            if ($hasil and $pakar) 
                echo "<p>Proses Input Data Sukses</p>";
            else 
                echo "<p>Proses Input Data Gagal".$hasil.$pakar."</p>";
        }
    ...
    <tr bgcolor="#FFFFFF">
        ...
        <td width="92" height="25">Hak</td>
        <td width="3" height="25">:</td>
        <td width="237" height="25"><input name="hak" type="radio" value="Pakar" checked />Pakar</td>
    </tr>
        <tr bgcolor="#FFFFFF">
        <td width="92" height="25">&nbsp;</td>
        <td width="3" height="25">&nbsp;</td>
