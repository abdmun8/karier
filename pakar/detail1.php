...
$id = $_GET['id'];
   ...
   $query = "DELETE FROM analisa_hasil WHERE id = '$id'";
...
Tanggal Konsul</span></td><td><span class="style1">Riwayat Konsul</span></td><td align="center"><span class="style1">Action</span></td></tr>
<?php
...
if ($brs==0) { echo"<tr align=\"center\"><td colspan=4>Siswa ini Belum Konsul</td></tr>"; }
else {
$no = 1;
...
echo "<td width=100 align=center><a href=\"".$_SERVER['PHP_SELF']."?kddetail=".$_GET['kddetail']."&op=delete&id=".$data1['id']."\">Hapus</a></td>";
echo "<tr>";
$no++;
}
}
